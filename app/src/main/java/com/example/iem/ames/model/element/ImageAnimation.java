...
public class ImageAnimation extends Image{
    ...
    public ImageAnimation(String filename, double x, double y, boolean isGIF, double duration, int numberOfFile, int numberOfRepeat, double translationX, double translationY, double translationZ, double movementDuration) {
